...
func Validate(iban string) error {
	...
	case "AZ":
		return validateAzerbaijanIBAN(iban)
	case "BA":
	...
	case "BH":
		return validateBahrainIBAN(iban)
	case "BI":
	...
	case "CZ":
		return validateCzechiaIBAN(iban)
	case "DE":
	...
	case "PS":
		return validatePalestineIBAN(iban)
	case "PT":
	...
	case "RU":
		return validateRussianFederationIBAN(iban)
	case "SA":
	...
	case "TR":
		return validateTurkiyeIBAN(iban)
	case "UA":
		return validateUkraineIBAN(iban)
	case "VA":
		return validateHolySeeIBAN(iban)
	case "VG":
		return validateVirginIslandsIBAN(iban)
	case "XK":
		return validateKosovoIBAN(iban)
	case "YE":
		return validateYemenIBAN(iban)
	case "AX":
		return validateAlandIslandsIBAN(iban)
	case "GF":
	...
	case "IM":
		return validateIsleOfManIBAN(iban)
	case "JE":
		return validateJerseyIBAN(iban)
	case "GG":
		return validateGuernseyIBAN(iban)
	default:
