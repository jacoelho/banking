...
// validateRepublicofBelarusIBAN validates Republic of Belarus IBAN
func validateRepublicofBelarusIBAN(iban string) error {
	if len(iban) != 22 {
...
// generateRepublicofBelarusIBAN generates Republic of Belarus IBAN
func generateRepublicofBelarusIBAN() string {
...
// getRepublicofBelarusBBAN retrieves BBAN structure from Republic of Belarus IBAN
func getRepublicofBelarusBBAN(iban string) (BBAN, error) {
	if len(iban) != 22 {
